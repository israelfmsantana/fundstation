...
interface ButtonWizardProps {
    stateStep: number;
    stateHandleSubmit: React.MouseEventHandler<HTMLButtonElement>;
    stateHandlePrevStep: React.MouseEventHandler<HTMLButtonElement>;

  }
  

const sumbitBtn: React.FC<ButtonWizardProps> = ({
    stateStep,
    stateHandleSubmit,
    stateHandlePrevStep
}) => {
